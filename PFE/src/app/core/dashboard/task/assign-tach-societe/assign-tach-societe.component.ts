...
@Component({
  selector: 'app-assign-tach-societe',
  standalone: true,
  imports: [AutoCompleteModule, FormsModule],
  templateUrl: './assign-tach-societe.component.html',
  styleUrl: './assign-tach-societe.component.scss'
})
export class AssignTachSocieteComponent implements OnInit {
